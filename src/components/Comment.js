...
function Comment (props){
   ...
   const [clearCommentField, setClearCommentField] = useState('')
    ...
    return(
        <div className="commentDisplay">
          <h6>{commentOrder}</h6>
          <input id="inputComment" type="text" placeholder="Leave a Comment" onClick={(e)=>{e.target.value=''}} onChange={(e=>{setCommentsStore(e.target.value)})}></input>
